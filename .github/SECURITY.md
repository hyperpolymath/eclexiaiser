...
Replace all {{PLACEHOLDER}} values with your information:
  eclexiaiser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  eclexiaiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/eclexiaiser/security/advisories/new)
...
- This repository (`hyperpolymath/eclexiaiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/eclexiaiser/security/advisories)
...
When using eclexiaiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/eclexiaiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/eclexiaiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/eclexiaiser/discussions) |
...
*Thank you for helping keep eclexiaiser and its users safe.* 🛡️
