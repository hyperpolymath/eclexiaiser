...
//
// eclexiaiser CLI — Add energy, carbon, and resource-cost awareness to existing software via Eclexia economics-as-code
...
/// eclexiaiser — Add energy, carbon, and resource-cost awareness to existing software via Eclexia economics-as-code
#[derive(Parser)]
...
#[derive(Subcommand)]
enum Commands {
    /// Initialise a new eclexiaiser.toml manifest.
    Init { #[arg(short, long, default_value = ".")] path: String },
    /// Validate a eclexiaiser.toml manifest.
    Validate { #[arg(short, long, default_value = "eclexiaiser.toml")] manifest: String },
    /// Generate Eclexia wrapper, Zig FFI bridge, and C headers.
    Generate {
        #[arg(short, long, default_value = "eclexiaiser.toml")] manifest: String,
        #[arg(short, long, default_value = "generated/eclexiaiser")] output: String,
    },
    /// Build the generated artifacts.
    Build { #[arg(short, long, default_value = "eclexiaiser.toml")] manifest: String, #[arg(long)] release: bool },
    /// Run the workload.
    Run {
        #[arg(short, long, default_value = "eclexiaiser.toml")] manifest: String,
    ...
    Info { #[arg(short, long, default_value = "eclexiaiser.toml")] manifest: String },
}
